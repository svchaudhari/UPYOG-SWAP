...
const ApplicantDetails = ({ applicantName, applicantMobileNumber, applicantEmailAddress, fetchTrdData }) => {
            ...
            <Table striped bordered hover className="styled-table">
              <tbody>
                <tr className="table-row">
                  ...
                  <td className="table-data">{additionalDetail?.applicantMobileNumber || "N/A"}</td>
                  <th className="table-header">
                    Email Address
                  </th>
