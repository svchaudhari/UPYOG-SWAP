...
$(document).ready(function($){
    ...
    $('.festivalLoadDom').on('change','.wts-filter',function(event) {

        event.preventDefault();

        let data = {},$this = $(this), parents = $(this).parents('.wts-filter-hold');
        let isSelectParentTerm = $(this).attr('data-parent'), action = "where_to_stay_ajax";
    ...
    $('.festivalLoadDom').on('click','.festivalLoad .pagination li a',function(event) {
        event.preventDefault();
        let data = {};
        let $this = $(this);
