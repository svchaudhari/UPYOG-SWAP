...
const ApplicantDetails = ({ formData, handleInputChange, errors }) => {
        ...
        <Row className="mb-4">
            ...
            <div className="form-group applicantMobileNumber required">
              <Form.Group controlId="applicantMobileNumber">
                ...
                <Form.Control
                  ...
                  value={JSON.parse(localStorage.getItem("userInfo")).mobileNumber}
                  onChange={handleInputChange}
                  readOnly="readonly"
          ...
          <Col md={4}>
            <div className="form-group applicantEmailAddress required">
              <Form.Group controlId="applicantEmailAddress">
                <Form.Label className="control-label">
                  {" "}
                  Email Address{" "}
                </Form.Label>{" "}
                <Form.Control
                  ...
                  value={JSON.parse(localStorage.getItem("userInfo")).emailId}
                  onChange={handleInputChange}
                  readOnly="readonly"
